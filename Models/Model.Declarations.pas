...
type
  ...
  private
    ...
    FSellingRate : double;
  public
    [Column('CurrencyDailyRateId', [cpRequired, cpPrimaryKey, cpNotNull, cpAutoGenerated], 0, 0, 0)]
  ...
  public
    [Column('PurchaseInvoiceHeaderId', [cpRequired, cpPrimaryKey, cpNotNull, cpAutoGenerated], 0, 0, 0)]
